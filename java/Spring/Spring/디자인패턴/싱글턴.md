...
---
실상황 예시
- **문제 상황**: HTTP는 연결-응답-종료를 반복 
  1.  매번 new로 객체 생성하면 성능 저하
...
**스프링을 쓰는 핵심 이유이다**
1. ✅ **싱글턴 패턴 코드 안 짜도 됨** - 어노테이션만 붙이면 끝
2. ✅ **의존성 관리 자동화** - new 없이 DI로 자동 연결
3. ✅ **객체 생명주기 관리** - IoC 컨테이너가 다 알아서
4. ✅ **결과적으로 개발자는 비즈니스 로직에만 집중!**
